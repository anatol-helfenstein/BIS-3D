#### Readme for groundwater table in soil profile (?) ####
By A.F. Helfenstein
2020-04-02
...
Content:		- groundwater table height in soil profile (?):
					1:	III =  H <40  L 80-120
					2:	VI =  H 40-80  L >120
					3:	VII* =  H >140  L >160
					4:	-
...
#### PROCESSING ####
1. Polygon to raster (target attribute = "GWT") using existing DEM (AHN2) to snap the raster to (25m x 25m resolution)
* snap raster = all cells are designated to same geographical location

2.	Raster to geoTIFF-format (conversion)

3. Change name from "bodem50_gwt_PolygonToRaster" to "bodem50_gwt_25m"



#### FINAL FILE ####
Name:			bodem50_gwt_25m.tif
