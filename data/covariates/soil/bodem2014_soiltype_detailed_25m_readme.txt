#### Readme for detailed Netherlands soil type map (Bodemkaart50000 Versie 2014) ####
By A.F. Helfenstein
2020-04-01
...
Content:		detailed soil type map of the Netherlands
				1696 categories
...
#### PROCESSING ####
1. Polygon to raster (target attribute = "BODEMCODE") using existing DEM (AHN2) to snap the raster to (25m x 25m resolution)
* snap raster = all cells are designated to same geographical location

2.	Raster to GeoTIFF-format (conversion)

3. Change name from "Bodemtypen_detailed_PolygonToRaster" to "bodem2014_soiltype_detailed_25m"



#### FINAL FILE ####
Name:			bodem2014_soiltype_detailed_25m.tif
