#### Readme for water and built-up areas from soil map (Bodemkaart50000 Versie 2014) ####
By A.F. Helfenstein
2020-04-01
...
Projection:		RD_new
Content:		- bebouwing en water areas in the national soil map:
					1: |g MOERAS
					2: |g WATER
					3: |h BEBOUW
...
#### PROCESSING ####
1. Polygon to raster (target attribute = "INFRACODE") using existing DEM (AHN2) to snap the raster to (25m x 25m resolution)
* snap raster = all cells are designated to same geographical location

2.	Raster to geoTIFF-format (conversion)

3. Change name from "Bebouwingenwater_PolygonToRaster" to "bodem2014_bebouwing_water_25m"



#### FINAL FILE ####
Name:			bodem2014_bebouwing_water_25m.tif
