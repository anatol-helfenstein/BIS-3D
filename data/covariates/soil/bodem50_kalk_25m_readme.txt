#### Readme for lime occurence in soil profile (?) ####
By A.F. Helfenstein
2020-04-02
...
Content:		- lime / calcareous occurence in soil profile (?):
					1:	A
					2:	C
					3:	<blank>: no occurence (?)
...
#### PROCESSING ####
1. Polygon to raster (target attribute = "KALK") using existing DEM (AHN2) to snap the raster to (25m x 25m resolution)
* snap raster = all cells are designated to same geographical location

2.	Raster to geoTIFF-format (conversion)

3. Change name from "bodem50_kalk_PolygonToRaster" to "bodem50_kalk_25m"



#### FINAL FILE ####
Name:			bodem50_kalk_25m.tif
