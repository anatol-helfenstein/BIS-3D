...
Content (NE):	LGN7_BRP2013 is een nieuwe versie van LGN7 waarbij de agrarische LGN7 klassen zijn geactualiseerd op basis van gegevens uit de BasisRegistratiePercelen 2013. De andere klassen (bebouwing, bos, water, infrastructuur en natuur) zijn gelijk gebleven t.o.v. het oorspronkelijke LGN7 bestand. Ook LGN7_BRP2015 (en LGN7_BRP2014) zijn op aanvraag beschikbaar.

				land use ordered in the following categories:
