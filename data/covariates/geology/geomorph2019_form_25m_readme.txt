#### Readme for geomorphological form classes of the Netherlands (2019 version)) ####
By A.F. Helfenstein
2020-04-02
...
Content:		- see website with legend info: https://legendageomorfologie.wur.nl/
				- geomorphological form (?) classes (categorical values: 1-8)
...
#### PROCESSING ####
1. Polygon to raster (target attribute = "Vorm_volgnr") using existing DEM (AHN2) to snap the raster to (25m x 25m resolution)

4. Raster to other format (.tif)

5. Change name from "GMK2019GeoMorfologie_PolygonToRaster_vorm" to "geomorph2019_form_25m"



#### FINAL FILE ####
Name:			geomorph2019_form_25m.tif
