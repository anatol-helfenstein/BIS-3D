#### Readme for relief characteristics based on geomorphological map of the Netherlands (2019 version)) ####
By A.F. Helfenstein
2020-04-02
...
Content:		- see website with legend info: https://legendageomorfologie.wur.nl/
				- relief characteristics based on geomorphological map of the Netherlands:
					- 46 classes
...
#### PROCESSING ####
1. Polygon to raster (target attribute = "Relief_code") using existing DEM (AHN2) to snap the raster to (25m x 25m resolution)

4. Raster to other format (.tif)

5. Change name from "GMK2019GeoMorfologie_PolygonToRaster_relief" to "geomorph2019_relief_25m"



#### FINAL FILE ####
Name:			geomorph2019_relief_25m.tif
