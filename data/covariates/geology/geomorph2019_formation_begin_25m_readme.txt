#### Readme for begin of geological formation process (from geomorphological map of the Netherlands (2019 version)) ####
By A.F. Helfenstein
2020-04-02
...
Content:		- see website with legend info: https://legendageomorfologie.wur.nl/
				- Code for begining of geological formation process that defines geomorphological unit
...
#### PROCESSING ####
1. Polygon to raster (target attribute = "Geologischtijdperk_vormingsproces_begint_id" = "Period (Eind_vormingsproces_omschr)")* using existing DEM (AHN2) to snap the raster to (25m x 25m resolution)
* something labeled incorrectly? is it beginning or end of formation process? TALK TO MARIJN!

4. Raster to other format (.tif)

5. Change name from "GMK2019GeoMorfologie_PolygonToRaster_vormingsproces_begint" to "geomorph2019_formation_begin_25m"



#### FINAL FILE ####
Name:			geomorph2019_formation_begin_25m.tif
